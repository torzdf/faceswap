...
enc_architecture = ConfigItem(
    ...
    info="The encoder architecture to use. See the relevant config sections for specific "
         "architecture tweaking.\nThe default input size for each model is shown in brackets. "
         "All encoders have an minimum input size of 32px unless otherwise stated."
         ...
         "\n\n\tconvnext: (224px). There are 6 variations of increasing complexity. Ref: A "
         "ConvNet for the 2020s (2022): https://arxiv.org/abs/1608.06993"
         "\n\n\tdensenet: (224px). Ref: Densely Connected Convolutional Networks (2016): "
         "https://arxiv.org/abs/1608.06993"
         "\n\n\tefficientnet: EfficientNet has numerous variants (B0 -B8) that increases the "
         "model width, depth and dimensional space at each step. The default input resolution for "
         "each variant is: b0: 224px, b1: 240px, b2: 260px, b3: 300px, b4: 380px, b5: 456px, b6: "
         "528px, b7 600px. Ref: Rethinking Model Scaling for Convolutional Neural Networks "
         ...
         "width, depth and dimensional space at each step. The default input resolution for each "
         "variant is: b0: 224px, b1: 240px, b2: 260px, b3: 300px, s: 384px, m: 480px, l: 480px. "
         "Ref: EfficientNetV2: Smaller Models and Faster Training (2021): "
         "https://arxiv.org/abs/2104.00298"
         "\n\n\tfs_original: (any size). A configurable variant of the original faceswap "
         ...
         "Lightweight."
         "\n\n\tinception_resnet_v2: (299px). Minimum input size is 75px. Ref: Inception-ResNet "
         "and the Impact of Residual Connections on Learning (2016): "
         "https://arxiv.org/abs/1602.07261"
         "\n\n\tinceptionV3: (299px). Minimum input size is 75p. Ref: Rethinking the Inception "
         "Architecture for Computer Vision (2015): https://arxiv.org/abs/1512.00567"
         "\n\n\tmobilenet: (224px). Additional MobileNet parameters can be set with "
         ...
         "\n\n\tmobilenet_v2: (224px). Additional MobileNet parameters can be set with the "
         "'mobilenet' options. Ref: MobileNetV2: Inverted Residuals and Linear Bottlenecks "
         "(2018): https://arxiv.org/abs/1801.04381"
         "\n\n\tmobilenet_v3: (224px). Additional MobileNet parameters can be set with "
         ...
         "\n\n\t vgg: (224px). Very Deep Convolutional Networks for Large-Scale Image "
